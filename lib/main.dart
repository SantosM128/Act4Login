  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            const Text('Petco Online', style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xff010863),
        elevation: 8,
      ),
      body: Padding(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/SantosM128/Img_IOS/main/FlutterFlowAct12/im3.jpg")),
            const Text('¡Has Iniciado Sesion Exitosamente!'),
            const SizedBox(height: 20.0),
            ...
            ElevatedButton(
              child: const Text(
                'Cerrar sesión',
                style: TextStyle(color: Color(0xff080101)),
              ),
              style: ElevatedButton.styleFrom(
                minimumSize: const Size(340, 40),
                backgroundColor: const Color(0xff010863),
